...
export default function SessionsList({
  ...
  return (
    ...
    >
      ...
      {n === 0 ? (
        <p className="px-0.5 pb-1 text-[13px] text-faint">
          ...
          {events.map((e, i) => {
            ...
            return (
              <div
                ...
                className={`flex min-w-0 items-center gap-3 rounded-xl px-3.5 py-3 ${i === n - 1 && n % 2 === 1 ? "lg:col-span-2" : ""}`}
              ...
              >
                ...
                {userId && onToggleJoin && !locked && (
                  <Pill
                    active={joined}
                    onClick={() => onToggleJoin(e)}
                    aria-pressed={joined}
